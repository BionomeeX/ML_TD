...
namespace MLTD.ML
{
    ...
    public abstract class ADataType
    {
        ...
        public abstract Numeric.Vector Gradient(Numeri.Vector data);
    ...
    public class Real : ADataType
    {
        ...
        public override Numeric.Vector Gradient(Numeric.Vector data)
        {
            Numeric.Vector result = new Numeric.Vector(data.size);
    ...
    public class RealPositive : ADataType
    {
        ...
        public override Numeric.Vector Gradient(Numeric.Vector data)
        {
            ...
            for (int i = 0; i < result.size; ++i)
            {
                result.At(i, data.At(i) > 0f ? 1f : 0f);
            }
            return result;
        }
        public override void Write(BinaryWriter writer)
